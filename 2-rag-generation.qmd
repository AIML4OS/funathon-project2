...
user_prompt = USER_PROMPT_TEMPLATE.format(
    ...
    proposed_nace_codes=codes_retrieved
)
...
# Inference and evaluation on multiple activities.

Next, let's use some synthetic data.
We will: 
- make the automatic classification on a sample of activities
- build some metrics to qualify our coding process
