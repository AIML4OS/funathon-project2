...
::: {.callout-note}
**Dataset structure:**
Each row contains a free-text activity label (`activity`) and its reference NACE 2.1 code (`nace_code`), produced by human annotation or a larger model. These reference codes will serve as the **gold standard** for evaluation.
:::
...
for t in thresholds:
    ...
    if len(subset) > 0:
        precisions.append(subset["pipeline_correct"].mean())
        coverages.append(len(subset) / len(results))
    else:
        precisions.append(None)
        coverages.append(0.0)

axes[1].plot(thresholds, precisions, marker="o", label="Precision",  color="steelblue")
axes[1].plot(thresholds, coverages,  marker="s", label="Coverage",   color="coral", linestyle="--")
axes[1].set_title("Precision and coverage\nvs. confidence threshold")
